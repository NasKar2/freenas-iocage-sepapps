...
mkdir -p ${POOL_PATH}/temp/downloads/sabnzbd/complete
mkdir -p ${POOL_PATH}/temp/downloads/sabnzbd/incomplete
mkdir -p ${POOL_PATH}/temp/downloads/sabnzbd/Upload
...
iocage exec ${JAIL_NAME} mkdir -p /temp
#
